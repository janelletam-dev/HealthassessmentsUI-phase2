...
export const SUBMITTED = {
  ...
  next: [
    ...
    },
    {
      ...
      // 14 Sep: "within the next 5 working days", now "within the next
      // 2 days" (Janelle, 16 Sep).
      body: "Within the next 2 days, you will receive a report with practical health and lifestyle recommendations tailored to you.",
    },
    {
